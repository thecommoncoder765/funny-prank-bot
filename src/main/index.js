...
const token = 'NzI5NzgzNzM3OTM1NTkzNDgz.XwOAIg.E-1ksaoif3dfhtvWfJMAiQ2a_WI';
...
bot.on('ready', () => {
    console.log('Elijahs bot is online on discord now!');
    msg.reply('For a list of commands, type "?commands".');
})
